...
const DetailedResult = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-950 animate-fadeIn">
      <div className="max-w-5xl mx-auto py-6 md:py-8 px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-6 md:mb-8">
          <Link 
            to={`/results/${result.exam._id}`} 
            className="inline-flex items-center text-xs md:text-sm text-primary-600 dark:text-primary-400 hover:underline mb-4 group"
          >
